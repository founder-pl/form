...
const SUPPORTED_COUNTRIES = ['DE', 'FR', 'ES', 'IT', 'NL', 'PT', 'BE', 'AT', 'SE', 'DK', 'FI', 'IE', 'LU', 'CH', 'NO', 'IS', 'US', 'CA', 'GB', 'AU', 'NZ', 'SG', 'AE', 'QA', 'HK', 'CN', 'KR', 'JP', 'IN', 'BR', 'MX', 'ZA', 'IL', 'RU', 'TR', 'ID', 'TH', 'VN', 'MY', 'PH', 'SA', 'AR', 'CL', 'CO', 'PE', 'UY', 'PY', 'BO', 'EC', 'CR', 'PA', 'DO', 'GT', 'HN', 'SV', 'NI', 'CU', 'VE', 'PR', 'JM', 'TT', 'BB', 'BS'];
